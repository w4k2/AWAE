...
def methods():
    ...
    _methods = [
        BALS(KUE(GaussianNB()), random_state=1410),
        BALS(ROSE(GaussianNB()), random_state=1410),
        BALS(KUE(HoeffdingTreeClassifier(split_criterion='hellinger')), random_state=1410),
        BALS(ROSE(HoeffdingTreeClassifier(split_criterion='hellinger')), random_state=1410),
        BALS(KUE(MLPClassifier(random_state=1410)), random_state=1410),
        BALS(ROSE(MLPClassifier(random_state=1410)), random_state=1410),
    ]
    return _methods
