...
def methods():
    ...
    _methods = [
        BALS(SEA(GaussianNB()), random_state=1410),
        BALS(AWE(base_estimator=GaussianNB()), random_state=1410),
        BALS(AUE(base_estimator=GaussianNB()), random_state=1410),
        BALS(LearnPPNSEClassifier(base_estimator=GaussianNB(), n_estimators=10), random_state=1410),
        BALS(OALE(base_estimator=GaussianNB()), random_state=1410),
        BALS(WAE(
        GaussianNB(),
        post_pruning=True,
        theta=0.05,
        ...
        BALS(SEA(HoeffdingTreeClassifier(split_criterion='hellinger')), random_state=1410),
        BALS(AWE(base_estimator=HoeffdingTreeClassifier(split_criterion='hellinger')), random_state=1410),
        BALS(AUE(base_estimator=HoeffdingTreeClassifier(split_criterion='hellinger')), random_state=1410),
        BALS(LearnPPNSEClassifier(base_estimator=HoeffdingTreeClassifier(split_criterion='hellinger'), n_estimators=10), random_state=1410),
        BALS(OALE(base_estimator=HoeffdingTreeClassifier(split_criterion='hellinger')), random_state=1410),
        BALS(WAE(
