...
#
#         scores = np.load("results/ex12_1/%s.npy" % stream)
...
#         print(os.shape)
#
# np.save("results12_1", ordered_scores)

# print(ordered_scores.shape)
# exit()
ex11 = np.load('results11_1.npy')
ex12 = np.load('results12_1.npy')
print(ex11.shape)
print(ex12.shape)

ex1 = np.concatenate((ex11, ex12), axis=2)
np.save("results1_1", ex1)
