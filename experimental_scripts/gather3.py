...
"""
import numpy as np
from config32 import *

# ordered_scores = np.zeros((replications(), len(streams(0)), len(base_estimators()), 7, 199, 1))
#
...
#
#         scores = np.load("results/ex32/%s.npy" % stream)
#         print(scores.shape)
#
...
#         try:
#             os = np.reshape(scores, (len(base_estimators()), 7, 199, 1))
...
#
#
# np.save("results32", ordered_scores)
#
