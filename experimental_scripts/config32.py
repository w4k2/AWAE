...
def methods():
    ...
    _methods = [
        BALS(SEA(MLPClassifier(random_state=1410)), random_state=1410),
        BALS(AWE(base_estimator=MLPClassifier(random_state=1410)), random_state=1410),
        BALS(AUE(base_estimator=MLPClassifier(random_state=1410)), random_state=1410),
        BALS(LearnPPNSEClassifier(base_estimator=MLPClassifier(random_state=1410), n_estimators=10), random_state=1410),
        BALS(OALE(base_estimator=MLPClassifier(random_state=1410)), random_state=1410),
        BALS(WAE(
